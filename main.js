...
var random_resource = "aDl2OEiH_EFH10mA_ewZ9A"; // You can change it with newer from here if X changed it. https://x.com/i/api/graphql/CHANGEWITHTHIS/UserTweetsAndReplies
...
async function fetch_tweets(cursor) {
    ...
    const params = new URLSearchParams({ variables: JSON.stringify(variables), features: JSON.stringify(features), fieldToggles: JSON.stringify(fieldToggles) });
